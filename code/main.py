...
def test(gen_Z, gen_H, val_loader):
    ...
    for idx, (zebra, horse) in enumerate(loop):
        ...
        save_image(fake_horse*0.5+0.5, f"Project7_CycleGAN/saved_images/fake_horse_{idx}.png")
        save_image(fake_zebra*0.5+0.5, f"Project7_CycleGAN/saved_images/fake_zebra_{idx}.png")
